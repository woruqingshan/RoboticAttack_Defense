...
from white_patch.openvla_dataloader import get_dataset, resolve_model_path
...
class OpenVLAAttacker(object):
    def __init__(
        ...
        resolved_repo, local_only = resolve_model_path(vla_path, model_root)
        self.processor = AutoProcessor.from_pretrained(resolved_repo, trust_remote_code=True, local_files_only=local_only)
        ...
        self.train_dataset, self.val_dataset, self.processor = get_dataset(
